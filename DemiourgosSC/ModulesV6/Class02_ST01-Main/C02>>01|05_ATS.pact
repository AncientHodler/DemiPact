...
(module ATS GOV
    ...
    (defun GOV|ATS|SC_NAME ()       (let ((ref-DALOS:module{OuronetDalosV4} DALOS)) (ref-DALOS::GOV|ATS|SC_NAME)))
    ...
    (defschema ATS|PropertiesSchema
        ...
        syphon:decimal
        syphoning:bool
        reward-tokens:[object{AutostakeV4.ATS|RewardTokenSchema}]
        c-rbt:string
        c-nfr:bool
        c-positions:integer
        c-limits:[decimal]
    ...
    (defun UR_RewardTokens:[object{AutostakeV4.ATS|RewardTokenSchema}] (atspair:string)
    ...
    (defun UR_RewardTokenList:[string] (atspair:string)
        (let
            ...
            (fold
                (lambda
                    (acc:[string] item:object{AutostakeV4.ATS|RewardTokenSchema})
    ...
    (defun UR_RoUAmountList:[decimal] (atspair:string rou:bool)
        (let
            ...
            (fold
                (lambda
                    (acc:[decimal] item:object{AutostakeV4.ATS|RewardTokenSchema})
                    (if rou
    ...
    (defun UR_RT-Data (atspair:string reward-token:string data:integer)
        (let
            (
                (ref-U|INT:module{OuronetIntegersV2} U|INT)
                (rt:[object{AutostakeV4.ATS|RewardTokenSchema}] (UR_RewardTokens atspair))
                (rtp:integer (URC_RewardTokenPosition atspair reward-token))
                (rto:object{AutostakeV4.ATS|RewardTokenSchema} (at rtp rt))
            )
    ...
    (defun UDC_ComposePrimaryRewardToken:object{AutostakeV4.ATS|RewardTokenSchema} (token:string nfr:bool)
        (UDC_RT token nfr 0.0 0.0)
    )
    (defun UDC_RT:object{AutostakeV4.ATS|RewardTokenSchema} (token:string nfr:bool r:decimal u:decimal)
    ...
    (defun C_UpdatePendingBranding:object{IgnisCollector.OutputCumulator}
        ...
        (let
            ...
            (with-capability (ATS|C>UPDATE-BRD entity-id)
                ...
                (ref-IGNIS::IC|UDC_BrandingCumulator (UR_OwnerKonto entity-id) 5.0)
            )
        )
    )
            ...
            (let
                (
                    ...
                    (ico2:object{IgnisCollector.OutputCumulator}
                        (ref-IGNIS::IC|UDC_ConstructOutputCumulator gas-costs ATS|SC_NAME trigger [])
                    )
                )
                (ref-DALOS::KDA|C_Collect patron kda-costs)
                (ref-IGNIS::IC|UDC_ConcatenateOutputCumulators [ico1 ico2] ats-ids)
            )
        )
    )
    (defun C_ToggleFeeSettings:object{IgnisCollector.OutputCumulator}
        ...
        (let
            ...
            (with-capability (ATS|S>TG_FEE atspair toggle fee-switch)
                ...
                (ref-IGNIS::IC|UDC_SmallCumulator (UR_OwnerKonto atspair))
            )
        )
    )
    (defun C_TurnRecoveryOff:object{IgnisCollector.OutputCumulator}
    ...
    ;;
    (defun DPMF|C_MoveCreateRole:object{IgnisCollector.OutputCumulator}
        ...
        (let
            (
                (ref-IGNIS:module{IgnisCollector} DALOS)
                (ref-DPMF:module{DemiourgosPactMetaFungibleV5} DPMF)
                (initial-create-role-account:string (ref-DPMF::UR_CreateRoleAccount id))
            )
            (with-capability (P|SECURE-CALLER)
                (ref-DPMF::XB_DeployAccountWNE id receiver)
                (ref-DPMF::XE_MoveCreateRole id receiver)
                (ref-DPMF::XB_WriteRoles id initial-create-role-account 2 false)
                (ref-DPMF::XB_WriteRoles id receiver 2 true)
                (let
                    (
                        (ico1:object{IgnisCollector.OutputCumulator}
                            (if (= initial-create-role-account ATS|SC_NAME)
                                (XI_RevokeCreateOrAddQ id)
                                EOC
                            )
                        )
                        (ico2:object{IgnisCollector.OutputCumulator}
                            (ref-IGNIS::IC|UDC_BigCumulator (ref-DPMF::UR_Konto id))
                        )
                    )
    ...
    (defun DPMF|C_ToggleAddQuantityRole:object{IgnisCollector.OutputCumulator}
    ...
    (defun DPMF|C_ToggleBurnRole:object{IgnisCollector.OutputCumulator}
        (id:string account:string toggle:bool)
        (UEV_IMC)
        (let
            (
    ...
    ;;
    (defun DPTF|C_ToggleBurnRole:object{IgnisCollector.OutputCumulator}
        (id:string account:string toggle:bool)
        (UEV_IMC)
        (let
            (
            ...
            (with-capability (P|SECURE-CALLER)
                ...
                (let
                    (
                        ...
                        (ico2:object{IgnisCollector.OutputCumulator}
                            (ref-IGNIS::IC|UDC_BigCumulator (ref-DPTF::UR_Konto id))
                        )
                    )
                    (ref-IGNIS::IC|UDC_ConcatenateOutputCumulators [ico1 ico2] [])
                )
    ...
    (defun DPTF|C_ToggleFeeExemptionRole:object{IgnisCollector.OutputCumulator}
        (id:string account:string toggle:bool)
        (UEV_IMC)
        (let
            (
    ...
    (defun DPTF|C_ToggleMintRole:object{IgnisCollector.OutputCumulator}
        (id:string account:string toggle:bool)
        (UEV_IMC)
        (let
            (
    ...
    ;;{F7}  [X]
    (defun XB_EnsureActivationRoles:object{IgnisCollector.OutputCumulator}
        (atspair:string cold-or-hot:bool)
                    ...
                    (with-capability (SECURE)
                        (if cold-or-hot
                            (let
                                ...
                                (ref-IGNIS::IC|UDC_ConcatenateOutputCumulators [ico4 ico5 ico6] [])
                            )
                            (let
                                (
                                    (h-rbt:string (UR_HotRewardBearingToken atspair))
                                    ...
                                    (ico7:object{IgnisCollector.OutputCumulator}
                                            (if (not h-rbt-burn-role)
                                            (DPMF|C_ToggleBurnRole h-rbt ats-sc true)
                                            EOC
                                        )
                                    )
                                    (ico8:object{IgnisCollector.OutputCumulator}
                                        (if (not h-rbt-create-role)
                                            (DPMF|C_MoveCreateRole h-rbt ats-sc)
                                            EOC
                                        )
                                    )
                                    (ico9:object{IgnisCollector.OutputCumulator}
                                ...
                                (ref-IGNIS::IC|UDC_ConcatenateOutputCumulators [ico7 ico8 ico9] [])
                            )
                        )
                    )
                )
    ...
    (defun XE_UpdateRoU (atspair:string reward-token:string rou:bool direction:bool amount:decimal)
        ...
        (let
            (
                ...
                (new-rt:object{AutostakeV4.ATS|RewardTokenSchema}
                    (if (= rou true)
                        (if (= direction true)
    ...
    ;;
    (defun XI_FoldedActivationRoles:object{IgnisCollector.OutputCumulator}
        (ats-ids:[string])
        (let
            (
                (ref-U|LST:module{StringProcessor} U|LST)
    ...
    (defun XI_MassTurnColdRecoveryOff:object{IgnisCollector.OutputCumulator}
        (id:string)
    ...
    (defun XI_RevokeBurn:object{IgnisCollector.OutputCumulator}
    ...
    (defun XI_RevokeCreateOrAddQ:object{IgnisCollector.OutputCumulator}
        (id:string)
    ...
    (defun XI_RevokeFeeExemption:object{IgnisCollector.OutputCumulator}
        (id:string)
    ...
    (defun XI_RevokeMint:object{IgnisCollector.OutputCumulator}
        (id:string)
    ...
    (defun XI_SetMassRole:object{IgnisCollector.OutputCumulator}
