...
(interface DeployerDispenserV2
    ...
    (defun UC_TTTF-Split:[decimal] (input:decimal ip:integer))  ;;remove
    ;;
...
(interface DeployerDispenserV3
    ...
    ;;
    (defun UC_ConvertPrice:string (input-price:decimal))        ;;remove
    ;;
    (defun URC_PrimordialPrices:[decimal] ())                   ;;remove
...
(module DSP GOV
    ...
    ;; SWP Module Logistic Reinitialisation
    (defun A_Step006 (patron:string primordial-pool)
        (let
            (
