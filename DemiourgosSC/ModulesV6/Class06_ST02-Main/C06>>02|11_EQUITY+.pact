(interface Equity
    ...
    ;;  [C]
    ;;
    (defun C_IssueShareholderCollection:object{IgnisCollector.OutputCumulator}
        (
    ...
    (defun C_MorphPackageShares:object{IgnisCollector.OutputCumulator} (account:string id:string input-nonce:integer input-amount:integer output-nonce:integer))
)
(module EQUITY GOV
    ;;
    ...
    (defun C_MorphPackageShares:object{IgnisCollector.OutputCumulator}
    ...
    ;;{F7}  [X]
    (defun XI_ConvertPackageShares:object{IgnisCollector.OutputCumulator}
    ...
    (defun XI_MakePackageShares:object{IgnisCollector.OutputCumulator}
    ...
    (defun XI_BreakPackageShares:object{IgnisCollector.OutputCumulator}
