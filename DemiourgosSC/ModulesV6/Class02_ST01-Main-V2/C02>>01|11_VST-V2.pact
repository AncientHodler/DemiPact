    ...
    (defcap VST|C>AWAKE (awaker:string dpof:string nonce:integer)
        (let
            (
                ...
                (ref-DPOF:module{DemiourgosPactOrtoFungible} DPOF)
                ;;
                (dptf:string (ref-DPOF::Hibernation dpof))
            )
            (ref-DALOS::UEV_EnforceAccountType awaker false)
            (ref-DPOF::UEV_Hibernation dptf true)
            (compose-capability (P|TT))
        )
    )
    ;;
                ...
                (let
                    ...
                    (ref-IGNIS::UDC_ConcatenateOutputCumulators
                        [
                            ...
                            (ref-DPOF::C_Burn dpof nonce VST|SC_NAME nonce-supply)
        ...
        (with-capability (VST|C>AWAKE awaker dpof nonce)
            (let
                (
                    ...
                    (release-time:time (at "mint-time" (at 0 meta-data-chain)))
        ...
        (with-capability (ATSU|C>CONSTRICT ats rt)
            (let
                (
                    ...
                    (ref-DPTF:module{DemiourgosPactTrueFungibleV6} DPTF)
                    ;;
                    (royalty-promile:decimal (ref-ATS::UR_Royalty ats))
                    ...
                    ;;
                    (royalty-split:[decimal] (ref-U|ATS::UC_PromilleSplit royalty-promile amount rt-prec))
                    ...
                    (final-input-amount:decimal (at 0 hibernating-split))
                    (final-hibernation-fee:decimal (at 1 hibernating-split))
                    ;;
                    (c-rbt:string (ref-ATS::UR_ColdRewardBearingToken ats))
                    (c-rbt-amount:decimal (ref-ATS::URC_RBT ats rt final-input-amount))
                )
                (let
                    (
                        (ico1:object{IgnisCollectorV2.OutputCumulator}
            ...
            (
                ...
                (special-of-id:[string]
                    (cond
                        ...
                        ((= vzh-tag 1) (ref-U|VST::UC_SleepingID dptf-name dptf-ticker))
                        ((= vzh-tag 1) (ref-U|VST::UC_HibernationID dptf-name dptf-ticker))
                        [BAR]
                    )
                )
    ...
    (defun XI_MergeNonces:object{IgnisCollectorV2.OutputCumulator}
        ...
        (let
            (
                ...
                (weigthed-locked-amount-in-seconds:decimal (at 2 compute-merge-all))
            )
            (ref-IGNIS::UDC_ConcatenateOutputCumulators
                [
