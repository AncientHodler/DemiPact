...
(interface DpdcManagement
    ...
    (defun C_WipeSlim:object{IgnisCollector.OutputCumulator} (account:string id:string nonce:integer amount:integer))
    ;;  [NFT]
    (defun C_BurnNFT:object{IgnisCollector.OutputCumulator} (account:string id:string nonce:integer))
    ;;  [SFT+NFT]
    (defun C_WipeNonce:object{IgnisCollector.OutputCumulator} (account:string id:string son:bool nonce:integer))
    ;;
    ;;  [DEBIT-MULTIPLE]
    ;;  [SFT+NFT]
    (defun C_WipeHeavy:object{IgnisCollector.OutputCumulator} (account:string id:string son:bool))
    (defun C_WipePure:object{IgnisCollector.OutputCumulator} (account:string id:string son:bool removable-nonces-obj:object{RemovableNonces}))
    (defun C_WipeClean:object{IgnisCollector.OutputCumulator} (account:string id:string son:bool nonces:[integer]))
    (defun C_WipeDirty:object{IgnisCollector.OutputCumulator} (account:string id:string son:bool nonces:[integer]))
)
;;
;;
