...
(module SWP GOV
    ...
    (defun SWP|UR_SpawnLimit:decimal ()
        (at "spawn-limit" (read SWP|Properties SWP|INFO ["spawn-limit"]))
    )
    (defun SWP|UR_InactiveLimit:decimal ()
    ...
    (defun SWP|UR_Primality:bool (swpair:string)
    ...
    (defun SWP|X_InsertNew (account:string pool-tokens:[object{SWP|PoolTokens}] token-lp:string fee-lp:decimal weights:[decimal] amp:decimal p:bool)
