(module SUT GOV
    ...
    ;;{10}
    ;;{11}
    (defun SUT|UC_ComputeWP (X:[decimal] input-amounts:[decimal] ip:[integer] op:integer o-prec w:[decimal])
        (let*
            (
    ...
    (defun SUT|UC_ComputeY (A:decimal X:[decimal] input-amount:decimal ip:integer op:integer o-prec:integer)
        (let*
            (
                (xi:decimal (at ip X))
                        ...
                        (lambda
                            ...
                            (let*
                                (
                                    ...
                                    (y-value:decimal (SUT|UC_YNext prev-y NewD A X op))
                                )
    ...
    (defun SUT|UC_YNext (Y:decimal D:decimal A:decimal X:[decimal] op:integer)
