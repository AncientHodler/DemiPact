...
(interface DpdcV3
    @doc "Holds Schema for Digital Collectibles, these being the DPSF and DPNF \
        ...
        \ V3 updates teh AccountSupply for more robust Read using Select"
...
(interface DpdcCreateV3
    ...
    \ V3 adds moves to DpdcUdcV2 interface"
    ;;
    ;;  [UC]
    ;;
