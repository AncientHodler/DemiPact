;;URD_CollectablesNonces to be added to DpdcV3
...
(module DPDC GOV
    ...
    (deftable DPSF|T|Nonces:{DpdcUdcV2.DPDC|NonceElement})            ;;Key = <DSPF-id> + BAR + <nonce>
