(module X GOVERNANCE
    ...
    (defun FunctionXX:decimal 
        ...
        (let*
            (
                (a:decimal
                    (with-capability (A.A|PRIMAL input-one input-two)
                        (A.FunctionA input-one input-two)
                    )
                )
                (b:decimal
                    (with-capability (BOBO.B|PRIMAL input-three input-four)
                        (BOBO.FunctionB input-one input-two)
                    )
                )
                (c:decimal
                    (with-capability (C.C|PRIMAL input-five input-six)
                        (C.FunctionC input-five input-six)
                    )
                )
