(interface SaleSnakes
    ...
    (defun URC_ShareCosts:object{DemiourgosLaunchpad.Costs} ())
    (defun URC_NonceCosts:object{DemiourgosLaunchpad.Costs} (nonce:integer))
    (defun URC_NonceAmountCosts:object{DemiourgosLaunchpad.Costs} (nonce:integer amount:integer))
    ;;
    ;;  [A+C]
    ;;
...
(module DEMIPAD-SNAKES GOV
    ...
    (defun GOV|DEMIPAD|SC_NAME ()              (let ((ref-DEMIPAD:module{DemiourgosLaunchpad} DEMIPAD)) (ref-DEMIPAD::GOV|DEMIPAD|SC_NAME)))
    ;;
    ;;<====>
    ;;POLICY
    ;;{P1}
    ...
    (defun URC_NonceCosts:object{DemiourgosLaunchpad.Costs} (nonce:integer)
        (let
            (
                ...
                (ref-DEMIPAD:module{DemiourgosLaunchpad} DEMIPAD)
                ;;
                (share-costs:object{DemiourgosLaunchpad.Costs} (URC_ShareCosts))
    ...
    (defun URC_NonceAmountCosts:object{DemiourgosLaunchpad.Costs} (nonce:integer amount:integer)
        (let
            (
                ...
                (ref-DEMIPAD:module{DemiourgosLaunchpad} DEMIPAD)
                ;;
                (nonce-costs:object{DemiourgosLaunchpad.Costs} (URC_NonceCosts nonce))
                ;;
                (wkda-id:string (ref-DALOS::UR_WrappedKadenaID))
                (wkda-prec:integer (ref-DPTF::UR_Decimals wkda-id))
            )
        ...
        (with-capability (SNAKES|ACQUIRE nonce amount)
            (let
                (
                    ...
                    ;;
                    (asset:string (UR_AssetID))
                    (costs:object{DemiourgosLaunchpad.Costs} (URC_NonceAmountCosts nonce amount))
