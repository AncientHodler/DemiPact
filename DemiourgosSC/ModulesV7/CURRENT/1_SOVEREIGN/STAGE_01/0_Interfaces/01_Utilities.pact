...
(interface UtilityAts
    ...
    (defun UC_QuadAnd:bool (b1:bool b2:bool b3:bool b4:bool)) ;;rm
    ...
    (defun UC_TripleAnd:bool (b1:bool b2:bool b3:bool)) ;;rm
    (defun UC_UnlockPrice:[decimal] (unlocks:integer))
    (defun UC_ZeroColdFeeExceptionBoolean:bool (fee-thresholds:[decimal] fee-array:[[decimal]])) ;;rm
    ;;
