                    ...
                    (lambda
                        ...
                        (ref-U|LST::UC_AppL acc
                            (ref-DPDC-UDC::UDC_NonceData
                                R
                                IR-L
                                (format "Bloodshed Epic #{}" [(at idx pos)])
                                d-l
                                [(ref-DPDC-UDC::UDC_Score (ES (at idx pos))) (E-x (at idx pos))]
                                type
                                (ref-DPDC-UDC::UDC_URI|Data (ref-BSL::BloodshedLink "Epic" (at idx pos)) b b b b b b)
                                zd
                                zd
                            )
                        )
