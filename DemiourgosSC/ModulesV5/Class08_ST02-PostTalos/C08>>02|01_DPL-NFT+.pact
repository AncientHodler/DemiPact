...
(module DPL-NFT GOV
    ...
    (defun A_Step001 ()
        (let
            ...
            (ref-P|DPDC-M::P|A_Define)
            (ref-P|DPDC-NM::P|A_Define)
            (ref-P|DPDC-NP::P|A_Define)
    ...
    (defun C_IssueCodingDivisionElements:string (patron:string dhcd-id:string)
        ...
        (let
            (
                ...
                (b:string "|")
                (primary-uri-lst:[object{Dpdc.DC|URI|Schema}]
                    (fold
                        (lambda
                            (acc:[object{Dpdc.DC|URI|Schema}] idx:integer)
                ...
                (secondary-uri-lst:[object{Dpdc.DC|URI|Schema}]
                    (fold
                        (lambda
                            (acc:[object{Dpdc.DC|URI|Schema}] idx:integer)
                            (ref-U|LST::UC_AppL acc
                ...
                (tertiary-uri:object{Dpdc.DC|URI|Schema}
                    {"image"    : b
                    ,"audio"    : b
                    ,"video"    : b
                    ,"document" : b
            ...
            (ref-TS02-C1::DPSF|C_Create
                ...
                (fold
                    (lambda
                        (acc:[object{Dpdc.DC|DataSchema}] idx:integer)
                        (ref-U|LST::UC_AppL acc
                            {"royalty"          : r
                            ,"ignis"            : i
                            ,"name"             : (at idx names)
