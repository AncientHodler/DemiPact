(module SWPL GOV
    ...
    (defun URC|KDA-PID_CLAD:object{SwapperLiquidity.CompleteLiquidityAdditionData}
        (
            ...
            (if iz-asymmetric
                (let
                    (
                        ...
                        (gaseous-text:string
                            (format "~{} LP out of a total ~{} Asym-LP, covered by {} IGNIS, as Asym-Liq.-FEE"
    ...
    ;;
    (defun URC_LD:object{SwapperLiquidity.LiquidityData} (swpair:string input-amounts:[decimal])
    ...
    (defun UDC_CompleteLiquidityAdditionData:object{SwapperLiquidity.CompleteLiquidityAdditionData}
        (
            ...
            r:object{SwapperLiquidity.CladOperation}
        )
    ...
    (defun UDC_CladOperation:object{SwapperLiquidity.CladOperation}
        (a:object{IgnisCollector.OutputCumulator} b:[string] c:[decimal] d:bool e:[string] f:[decimal] g:[decimal] h:[decimal])
        {"perfect-ignis-fee"            : a
        ;;
        ,"mt-ids"                       : b
        ,"mt-amt"                       : c
