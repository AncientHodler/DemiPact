(module DPDC GOV
    ...
    (defschema DPSF|PropertiesSchema
        @doc "Key = <DPSF id>"
        exist:bool
        sft:[object{Dpdc.DPDC|NonceElementSchema}]
        sft-specs:object{Dpdc.DPDC|PropertiesSchema}
        sft-sets:[object{Dpdc.DPDC|Set}]
        existing-roles:object{Dpdc.DPDC|RolesStorageSchema}
    )
    (defschema DPSF|BalanceSchema
        ...
        ;;
        roles:object{Dpdc.DPDC|RolesSchema}
    ...
    (defschema DPNF|PropertiesSchema
        @doc "Key = <DPNF id>"
        exist:bool
        nft:[object{Dpdc.DPDC|NonceElementSchema}]
        nft-specs:object{Dpdc.DPDC|PropertiesSchema}
        nft-sets:[object{Dpdc.DPDC|Set}]
        existing-roles:object{Dpdc.DPDC|RolesStorageSchema}
    )
    ...
    (defun UR_NonceElement:object{Dpdc.DPDC|NonceElementSchema}
    ...
    (defun UR_NonceData:object{Dpdc.DC|DataSchema}
        (id:string sft-or-nft:bool nonce:integer)
        (UEV_Nonce id sft-or-nft nonce)
        (if (< nonce 0)
    ...
    (defun UR_NonceAssetType:object{Dpdc.DC|URI|Type} 
        (id:string sft-or-nft:bool nonce:integer)
        (at "asset-type" (UR_NonceData id sft-or-nft nonce))
    )
    (defun UR_NonceUriOne:object{Dpdc.DC|URI|Schema}
        (id:string sft-or-nft:bool nonce:integer)
        (at "uri-primary" (UR_NonceData id sft-or-nft nonce))
    )
    (defun UR_NonceUriTwo:object{Dpdc.DC|URI|Schema} 
        (id:string sft-or-nft:bool nonce:integer)
        (at "uri-secondary" (UR_NonceData id sft-or-nft nonce))
    )
    (defun UR_NonceUriThree:object{Dpdc.DC|URI|Schema} 
        (id:string sft-or-nft:bool nonce:integer)
    ...
    (defun UR_ElementsSFT:[object{Dpdc.DPDC|NonceElementSchema}] 
        (id:string)
        (at "sft" (read DPSF|PropertiesTable id ["sft"]))
    )
    (defun UR_ElementsNFT:[object{Dpdc.DPDC|NonceElementSchema}] 
        (id:string)
        (at "nft" (read DPNF|PropertiesTable id ["nft"]))
    )
    (defun UR_CollectionSpecs:object{Dpdc.DPDC|PropertiesSchema}
    ...
    (defun UR_CollectionSets:[object{Dpdc.DPDC|Set}]
        (id:string sft-or-nft:bool)
        (if sft-or-nft
    ...
    (defun UR_CollectionRoles:object{Dpdc.DPDC|RolesStorageSchema}
        (id:string sft-or-nft:bool)
        (if sft-or-nft
    ...
    (defun UR_CA|R:object{Dpdc.DPDC|RolesSchema}
    ...
    (defun UEV_IzNonceFragmented:bool (id:string sft-or-nft:bool nonce:integer)
        ...
        (let
            (
                (split-nonce-data:object{Dpdc.DC|DataSchema}
                    (at "split-data" (UR_NonceElement id sft-or-nft nonce))
                )
                (empty-nonce-data:object{Dpdc.DC|DataSchema}
                    (UDC_EmptyDataDC)
                )
            )
    ...
    (defun UDC_AllProperties:object{DPSF|PropertiesSchema}
        (   
            ...
            b:[object{Dpdc.DPDC|NonceElementSchema}]
            c:object{Dpdc.DPDC|PropertiesSchema}
            d:[object{Dpdc.DPDC|Set}]
            e:object{Dpdc.DPDC|RolesStorageSchema}
        )
    ...
    (defun UDC_Properties:object{Dpdc.DPDC|PropertiesSchema}
        (
    ...
    (defun UDC_Control:object{Dpdc.DPDC|PropertiesSchema}
    ...
    (defun UDC_ExistingRoles:object{Dpdc.DPDC|RolesStorageSchema}
    ...
    (defun UDC_AllBalanceSFT:object{DPSF|BalanceSchema}
        (
            ...
            d:object{Dpdc.DPDC|RolesSchema} e:bool
        )
        @doc "Does not appear in Interface"
        {"exist"                    : a
        ,"owned-nonces"             : b
    ...
    (defun UDC_AllBalanceNFT:object{DPNF|BalanceSchema}
        (
            a:bool b:[integer] 
            c:object{Dpdc.DPDC|RolesSchema}
        )
        @doc "Does not appear in Interface"
        {"exist"                    : a
        ,"owned-nonces"             : b
    ...
    (defun UDC_AccountRoles:object{Dpdc.DPDC|RolesSchema} 
    ...
    (defun UDC_NonceElement:object{Dpdc.DPDC|NonceElementSchema} 
        (   
            a:integer b:integer c:integer 
            d:object{Dpdc.DC|DataSchema}
            e:object{Dpdc.DC|DataSchema}
        )
        {"nonce-set-class"  : a
        ,"nonce-value"      : b
        ,"nonce-supply"     : c
    ...
    (defun UDC_UriType:object{Dpdc.DC|URI|Type}
    ...
    (defun UDC_UriString:object{Dpdc.DC|URI|Schema}
    ...
    ;;
    (defun UDC_SetSingleElement:object{Dpdc.DPDC|SetSingleElement}
        (set-class:integer set-nonce:integer)
        {"set-class"    : set-class
        ,"set-nonce"    : set-nonce}
    )
    (defun UDC_SetElement:object{Dpdc.DPDC|SetElement}
        (input:[object{Dpdc.DPDC|SetSingleElement}])
        {"set-element"  : input}
    )
    (defun UDC_Set:object{Dpdc.DPDC|Set}
        (   
            class:integer name:string active:bool
            set:[object{Dpdc.DPDC|SetElement}]
        )
        {"class"    : class
        ,"name"     : name
        ,"active"   : active
    ...
    (defun UDC_Score:object{Dpdc.DPDC|Score} (score:decimal)
        {"score"    : score}
    )
    ;;Empty UDCs
    (defun UDC_NonceZeroElement:object{Dpdc.DPDC|NonceElementSchema} ()
        (UDC_NonceElement 0 0 0 (UDC_EmptyDataDC) (UDC_EmptyDataDC))
    )
    (defun UDC_EmptyDataDC:object{Dpdc.DC|DataSchema} ()
        (let
            (
                (z:decimal 0.0)
                (eut:object{Dpdc.DC|URI|Type} (UDC_EmptyUriType))
                (eus:object{Dpdc.DC|URI|Schema} (UDC_EmptyUriString))
            )
            (UDC_DataDC z z BAR BAR [{}] eut eus eus eus)
        )
    )
    (defun UDC_EmptyUriType:object{Dpdc.DC|URI|Type} ()
        (UDC_UriType false false false false false false false)
    )
    (defun UDC_EmptyUriString:object{Dpdc.DC|URI|Schema} ()
        (UDC_UriString BAR BAR BAR BAR BAR BAR BAR)
    )
    (defun UDC_ZeroSet:object{Dpdc.DPDC|Set} ()
        {"class"        : 0
        ,"name"         : "ZERO"
        ,"active"       : false
        ,"set"          : [{"set-element" : [(UDC_SetSingleElement 0 0)]}]
        ,"nonce-data"   : (UDC_EmptyDataDC)
        ,"split-data"   : (UDC_EmptyDataDC)
        }
    )
    (defun UDC_NoScore:object{Dpdc.DPDC|Score} ()
        (UDC_Score -1.0)
    )
    ;;
    ;;{F4}  [CAP]
    ...
    (defun XE_UP|SftOrNft (id:string sft-or-nft:bool sft-and-nft:[object{Dpdc.DPDC|NonceElementSchema}])
        (UEV_IMC)
        (if sft-or-nft
    ...
    (defun XB_UP|Specs (id:string sft-or-nft:bool specs:object{Dpdc.DPDC|PropertiesSchema})
        (UEV_IMC)
        (if sft-or-nft
            (update DPSF|PropertiesTable id
                { "sft-specs"           : specs}
    ...
    (defun XB_UP|Sets (id:string sft-or-nft:bool sets:[object{Dpdc.DPDC|Set}])
        (UEV_IMC)
        (if sft-or-nft
            (update DPSF|PropertiesTable id
                { "sft-sets"            : sets}
    ...
    (defun XB_UP|ExistingRoles (id:string sft-or-nft:bool er:object{Dpdc.DPDC|RolesStorageSchema})
        (UEV_IMC)
        (if sft-or-nft
            (update DPSF|PropertiesTable id
                { "existing-roles"      : er}
    ...
    (defun XB_UAD|Roles (id:string sft-or-nft:bool account:string roles:object{Dpdc.DPDC|RolesSchema})
        (UEV_IMC)
        (if sft-or-nft
            (update DPSF|BalanceTable (concat [id BAR account])
                { "roles"               : roles}
