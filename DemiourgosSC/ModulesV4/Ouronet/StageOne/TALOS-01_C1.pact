(interface TalosStageOne_ClientOne
    ;;
    ;;DALOS Functions
    (defun DALOS|C_ControlSmartAccount (patron:string account:string payable-as-smart-contract:bool payable-by-smart-contract:bool payable-by-method:bool)) ;d
    (defun DALOS|C_DeploySmartAccount (account:string guard:guard kadena:string sovereign:string public:string)) ;d
    ...
    (defun DALOS|C_RotateGuard (patron:string account:string new-guard:guard safe:bool)) ;d
    (defun DALOS|C_RotateKadena (patron:string account:string kadena:string)) ;d
    (defun DALOS|C_RotateSovereign (patron:string account:string new-sovereign:string)) ;d
    ;;
    ;;
    ;;DPTF (Demiourgos Pact True Fungible) Functions
    (defun DPTF|C_UpdatePendingBranding (patron:string entity-id:string logo:string description:string website:string social:[object{Branding.SocialSchema}])) ;d
    (defun DPTF|C_UpgradeBranding (patron:string entity-id:string months:integer)) ;d
    ;;
    ...
    (defun DPTF|C_Burn (patron:string id:string account:string amount:decimal)) ;d
    (defun DPTF|C_ClearDispo (patron:string account:string)) ;d
    (defun DPTF|C_Control (patron:string id:string cco:bool cu:bool casr:bool cf:bool cw:bool cp:bool)) ;d
    (defun DPTF|C_DeployAccount (id:string account:string)) ;d
    (defun DPTF|C_DonateFees (patron:string id:string)) ;d
    ...
    (defun DPTF|C_ResetFeeTarget (patron:string id:string)) ;d
    (defun DPTF|C_RotateOwnership (patron:string id:string new-owner:string)) ;d
    ...
    (defun DPTF|C_ToggleFreezeAccount (patron:string id:string account:string toggle:bool)) ;d
    (defun DPTF|C_ToggleMintRole (patron:string id:string account:string toggle:bool)) ;d
    (defun DPTF|C_TogglePause (patron:string id:string toggle:bool)) ;d
    (defun DPTF|C_ToggleReservation (patron:string id:string toggle:bool)) ;d
    (defun DPTF|C_ToggleTransferRole (patron:string id:string account:string toggle:bool)) ;d
    (defun DPTF|C_Transfer (patron:string id:string sender:string receiver:string transfer-amount:decimal method:bool)) ;d
    (defun DPTF|C_Transmute (patron:string id:string transmuter:string transmute-amount:decimal)) ;d
    (defun DPTF|C_Wipe (patron:string id:string atbw:string)) ;d
    (defun DPTF|C_WipePartial (patron:string id:string atbw:string amtbw:decimal)) ;d
    ;;
    ;;
    ...
    (defun DALOS|C_ControlSmartAccount (patron:string account:string payable-as-smart-contract:bool payable-by-smart-contract:bool payable-by-method:bool)
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron account 
    ...
    (defun DPTF|C_UpdatePendingBranding (patron:string entity-id:string logo:string description:string website:string social:[object{Branding.SocialSchema}])
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron (ref-DPTF::UR_Konto entity-id) 
    ...
    (defun DPTF|C_BulkTransfer (patron:string id:string sender:string receiver-lst:[string] transfer-amount-lst:[decimal] method:bool)
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron sender 
    ...
    (defun DPTF|C_ToggleFeeLock (patron:string id:string toggle:bool)
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron (ref-DPTF::UR_Konto id) [ico])
    ...
    (defun DPTF|C_Transmute (patron:string id:string transmuter:string transmute-amount:decimal)
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron transmuter 
    ...
    (defun DPMF|C_UpdatePendingBranding (patron:string entity-id:string logo:string description:string website:string social:[object{Branding.SocialSchema}])
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron (ref-DPMF::UR_Konto entity-id) 
    ...
    (defun DPMF|C_Control (patron:string id:string cco:bool cu:bool casr:bool cf:bool cw:bool cp:bool ctncr:bool)
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron (ref-DPMF::UR_Konto id) 
    ...
    (defun DPMF|C_Wipe (patron:string id:string atbw:string)
        ...
        (with-capability (P|TS)
            (let
                ...
                (ref-TS01-A::XE_IgnisCollect patron atbw 
